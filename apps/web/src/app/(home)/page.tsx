	...
	return (
		<div className={styles.heroContainer}>
			...
			<div className={styles.container}>
				{/* Header */}
				<header className={`${styles.header} ${headerVisible ? styles.fadeInDown : styles.hidden}`}>
					{/* <ThemeImage
...
const FeatureSection = () => {
	...
	return (
		<section className={styles.featuresSection}>
			<h2 className={styles.featuresTitle}>เราจะช่วยให้การจัดอีเวนต์สะดวกขึ้นได้อย่างไร</h2>
			<p className={styles.featuresSubtitle}>เราออกแบบโดยอิงพื้นฐานจาก Pain Point นักจัดอีเวนต์หลากๆ ที่</p>
...
const TestimonialSection: React.FC = () => {
	...
	return (
		<section className={styles.testimonialSection}>
			...
			<p className={styles.testimonialNote}>*หมายเหตุ: ลูกค้าในอนาคต (fraud จัด) </p>
		</section>
	);
};
	...
	return (
		<section className={styles.demoSection}>
			...
			<div className={styles.demoRight}>
				...
				<p className={styles.demoTryDesc}>ช่วยให้ทีมของคุณทำงานราบรื่น ตรงเวลา และมั่นใจในทุกช่วงของอีเวนต์</p>
...
const FooterSection: React.FC = () => {
	return (
		<footer className={styles.footer}>
			...
			<div className={styles.footercopyRight}>© 2024 Copyright, All Right Reserved, Eventer</div>
		</footer>
	);
};
