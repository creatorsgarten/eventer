// Elysia integration for Vercel serverless functions
export default async function handler(req: any, res: any) {
	try {
		...
		// Dynamic import to avoid build issues with workspace dependencies
		const { app } = await import("../src/index.js");

		console.log("Elysia app imported successfully");
