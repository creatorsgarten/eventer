...
export default function Footer() {
	...
	return (
		<footer className="flex flex-col items-center justify-center gap-3 p-8">
			...
			<div className="text-gray-500">© {currentYear} Oknize. All rights reserved.</div>
			<p className="text-center text-sm text-gray-500">
				{user?.email ? (
					...
					<button type="button" className="underline hover:no-underline" onClick={signInWithGoogle}>
						Sign in
					</button>
				)}
			</p>
